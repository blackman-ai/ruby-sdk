  ...
  class Usage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BlackmanClient::Usage` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BlackmanClient::Usage`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @completion_tokens < 0
        invalid_properties.push('invalid value for "completion_tokens", must be greater than or equal to 0.')
      end
      ...
      if @prompt_tokens < 0
        invalid_properties.push('invalid value for "prompt_tokens", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @completion_tokens < 0
      return false if @prompt_tokens.nil?
      return false if @prompt_tokens < 0
    ...
    def completion_tokens=(completion_tokens)
      ...
      if completion_tokens < 0
        fail ArgumentError, 'invalid value for "completion_tokens", must be greater than or equal to 0.'
      end
    ...
    def prompt_tokens=(prompt_tokens)
      ...
      if prompt_tokens < 0
        fail ArgumentError, 'invalid value for "prompt_tokens", must be greater than or equal to 0.'
      end
