...
# Unit tests for BlackmanClient::FeedbackApi
...
describe 'FeedbackApi' do
  ...
  describe 'test an instance of FeedbackApi' do
    it 'should create an instance of FeedbackApi' do
      expect(@api_instance).to be_instance_of(BlackmanClient::FeedbackApi)
    end
  end

  # unit tests for submit_feedback
  # Submit feedback for a completion response
  # @param submit_feedback_request 
  # @param [Hash] opts the optional parameters
  # @return [SubmitFeedbackResponse]
  describe 'submit_feedback test' do
    it 'should work' do
