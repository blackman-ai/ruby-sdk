...
# Unit tests for BlackmanClient::ImageUrl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::ImageUrl do
  let(:instance) { BlackmanClient::ImageUrl.new }

  describe 'test an instance of ImageUrl' do
    it 'should create an instance of ImageUrl' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::ImageUrl)
    end
  end
