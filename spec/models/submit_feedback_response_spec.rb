...
# Unit tests for BlackmanClient::SubmitFeedbackResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::SubmitFeedbackResponse do
  let(:instance) { BlackmanClient::SubmitFeedbackResponse.new }

  describe 'test an instance of SubmitFeedbackResponse' do
    it 'should create an instance of SubmitFeedbackResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::SubmitFeedbackResponse)
    end
  end
