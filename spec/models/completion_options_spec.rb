...
# Unit tests for BlackmanClient::CompletionOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::CompletionOptions do
  let(:instance) { BlackmanClient::CompletionOptions.new }

  describe 'test an instance of CompletionOptions' do
    it 'should create an instance of CompletionOptions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::CompletionOptions)
    end
  end
