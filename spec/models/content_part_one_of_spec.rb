...
# Unit tests for BlackmanClient::ContentPartOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::ContentPartOneOf do
  let(:instance) { BlackmanClient::ContentPartOneOf.new }

  describe 'test an instance of ContentPartOneOf' do
    it 'should create an instance of ContentPartOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::ContentPartOneOf)
    end
  end
