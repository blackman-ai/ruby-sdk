...
# Unit tests for BlackmanClient::ContentPartOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::ContentPartOneOf1 do
  let(:instance) { BlackmanClient::ContentPartOneOf1.new }

  describe 'test an instance of ContentPartOneOf1' do
    it 'should create an instance of ContentPartOneOf1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::ContentPartOneOf1)
    end
  end
