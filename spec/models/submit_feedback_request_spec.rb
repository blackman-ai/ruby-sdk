...
# Unit tests for BlackmanClient::SubmitFeedbackRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::SubmitFeedbackRequest do
  let(:instance) { BlackmanClient::SubmitFeedbackRequest.new }

  describe 'test an instance of SubmitFeedbackRequest' do
    it 'should create an instance of SubmitFeedbackRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::SubmitFeedbackRequest)
    end
  end

  describe 'test attribute "is_positive"' do
    it 'should work' do
