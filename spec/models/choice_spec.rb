...
# Unit tests for BlackmanClient::Choice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::Choice do
  let(:instance) { BlackmanClient::Choice.new }

  describe 'test an instance of Choice' do
    it 'should create an instance of Choice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::Choice)
    end
  end
