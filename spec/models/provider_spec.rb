...
# Unit tests for BlackmanClient::Provider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::Provider do
  let(:instance) { BlackmanClient::Provider.new }

  describe 'test an instance of Provider' do
    it 'should create an instance of Provider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::Provider)
    end
  end
