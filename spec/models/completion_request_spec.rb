...
# Unit tests for BlackmanClient::CompletionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::CompletionRequest do
  let(:instance) { BlackmanClient::CompletionRequest.new }

  describe 'test an instance of CompletionRequest' do
    it 'should create an instance of CompletionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::CompletionRequest)
    end
  end
