...
# Unit tests for BlackmanClient::InvalidateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::InvalidateResponse do
  let(:instance) { BlackmanClient::InvalidateResponse.new }

  describe 'test an instance of InvalidateResponse' do
    it 'should create an instance of InvalidateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::InvalidateResponse)
    end
  end
