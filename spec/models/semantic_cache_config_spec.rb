...
# Unit tests for BlackmanClient::SemanticCacheConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BlackmanClient::SemanticCacheConfig do
  let(:instance) { BlackmanClient::SemanticCacheConfig.new }

  describe 'test an instance of SemanticCacheConfig' do
    it 'should create an instance of SemanticCacheConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(BlackmanClient::SemanticCacheConfig)
    end
  end
